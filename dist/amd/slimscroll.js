/**
 * Slimscroll is a small AMD module with no library dependencies (sans jquery) that transforms any div into a scrollable area with a nice scrollbar
 * @license MIT
 * @module slimscroll
 * @requires classie
 * @requires util-extent
 * @requires domhelper
 */

define(['classie', 'util-extend', 'domhelper'], function (classie, extend, domhelper) {
